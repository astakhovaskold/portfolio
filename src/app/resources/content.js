...
const about = {
    ...
    intro: {
        ...
        cv: '/docs/Askold_Astakhov_CV.pdf',
        description: (
            <>
        ...
        experiences: [
            {
                ...
                achievements: [
                    <>
                        Redesigned the UI/UX for the FLY platform, resulting in a 20% increase in user engagement and
            ...
            },
            {
                ...
                achievements: [
                    ...
                    <>
                        Led a cross-functional team to launch a new product line, contributing to a 15% increase in
