...
const Accordion: React.FC<AccordionProps> = forwardRef(({title, children, style, className, open = false}, ref) => {
    ...
    return (
        <Flex fillWidth direction="column" style={style} className={classNames(styles.border, className)}>
            <Flex
                tabIndex={0}
