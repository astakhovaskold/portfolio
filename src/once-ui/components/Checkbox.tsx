...
const Checkbox: React.FC<CheckboxProps> = forwardRef<HTMLInputElement, CheckboxProps>(
    (
        {style, className, isChecked: controlledIsChecked, isIndeterminate = false, onToggle, disabled, ...props},
        ref,
    ) => {
        ...
        return (
            ...
            >
                <input
                    ...
                    ref={ref}
                    aria-checked={
                        isIndeterminate ? 'mixed' : controlledIsChecked !== undefined ? controlledIsChecked : isChecked
                    }
                ...
                <Flex
                    ...
                    className={classNames(styles.element, {
                        [styles.checked]:
                            controlledIsChecked !== undefined ? controlledIsChecked || isIndeterminate : isChecked,
