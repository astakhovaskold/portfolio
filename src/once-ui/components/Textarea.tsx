    ...
    (
        ...
        return (
            <div className={classNames(styles.wrapper, className, {[styles.error]: error})}>
                <div className={classNames(styles.base, styles.textareaBase)} style={{borderRadius: radius}}>
                    {hasPrefix && (
                ...
                {description && (
                    <Flex paddingX="16">
                        <Text as="span" id={`${id}-description`} variant="body-default-s" onBackground="neutral-weak">
                            {description}
                        </Text>
                    </Flex>
                )}
