...
export const HeadingLink: React.FC<HeadingLinkProps> = ({id, level, children, style}) => {
    ...
    const addToast = useCallback((variant: 'success' | 'danger', message: string, action?: React.ReactNode) => {
    ...
    return (
        <Flex>
            ...
            <Flex style={style} onClick={() => copyURL(id)} className={styles.control} alignItems="center" gap="4">
